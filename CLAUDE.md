...
- **英语课程特殊规则**：
  - 在双语模式下，英语课程（FCE）的显示顺序与数学/理科课程**相反**——**英文在上**（主语言），**中文在下**（辅助翻译，小号灰色）
  - **每日练习各 Tab 的语言规则**：
    - 📖 Reading：**纯英文**（阅读沉浸，无中文）
    - 📝 Vocabulary：**双语**（英主中辅，需要中文释义帮助理解词义）
    - 🔧 Grammar：**纯英文**（语法练习全英文环境）
    - 🧩 Use of English：**纯英文**（词形转换全英文环境）
    - 🎧 Listening：**纯英文**（听力练习全英文环境）
    - ✍️ Writing：**双语**（英主中辅，写作提示需中文辅助理解）
